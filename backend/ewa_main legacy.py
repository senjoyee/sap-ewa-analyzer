...
# Legacy monolithic route handlers were removed after extraction into modular routers.
# The main file now only holds configuration, router registration, and CORS setup.  # migrated to storage_router
