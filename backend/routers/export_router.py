...
async def export_json_to_excel(blob_name: str):
    ...
    try:
        # Agentic-first path: if a prebuilt workbook exists for this blob, return it directly.
        ...
        try:
            ...
            logger.info("[Excel Export] Agentic workbook not found (%s), falling back to JSON export", workbook_blob_name)
